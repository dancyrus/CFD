...
impl Preset {
    ...
    fn anchors(self) -> Option<&'static [(f32, [u8; 3])]> {
        Some(match self {
            ...
            // 9 anchors · max ΔE00 1.72 · L* 11.2→91.6 (apex at 0.49)→16.3.
            // The anchor at 0.4863 is the light apex and is not decoration:
            ...
            // 10 anchors · max ΔE00 1.47 · step CV 19.2%. ParaView's classic
            ...
            // 12 anchors · max ΔE00 1.99 vs real turbo. This is the table §7
